...
const CAL_NAMESPACE = 'costless-demo'
...
function useCalEmbed() {
  useEffect(() => {
    ...
    Cal.ns[CAL_NAMESPACE]('inline', {
      elementOrSelector: '#ifu-costless-demo-cal',
...
export default function CostlessDemoPageClient() {
  useCalEmbed()
  return (
    <>
        ...
        <div className="demo-hero-inner">
          <div className="demo-hero-left">
            <div className="demo-eyebrow">
              ...
              iFu Costless · Product Demo
            </div>
            <h1 className="demo-hero-title">
              Cost Optimisation<br/><em>Tool.</em>
            </h1>
            <p className="demo-hero-sub">
              Connect your AWS account and get a live view of waste, savings opportunities, and spend anomalies — updated daily.
            </p>
            <ul className="demo-feature-list">
              {[
                ...
                'Monthly executive spend report',
              ].map(f => <li key={f}>{f}</li>)}
            </ul>
            <div className="demo-price">From <strong>$199</strong> / month · or add to your retainer</div>
            <div className="demo-hero-actions">
              <a href={`${PORTAL_URL}/onboarding?product=finops&plan=starter`} className="btn-cta primary">
                Start free trial
          ...
          <div className="demo-hero-right">
            <div className="demo-preview-card">
              <div className="demo-preview-head">
                ...
                <span className="demo-preview-dot" />
                <span className="demo-preview-title">iFu Costless · Monthly Spend</span>
              </div>
      ...
      <section className="demo-cal-section" id="demo-cal">
        <div className="demo-cal-inner">
          ...
          <h2 className="section-title">Pick a time to see<br/>iFu Costless <em>in action.</em></h2>
          <p className="section-sub">We&apos;ll walk you through idle resource detection, RI & Savings Plan analysis, and anomaly alerts — using your own AWS account if you&apos;d like.</p>
          <div id="ifu-costless-demo-cal" className="demo-cal-embed" />
        </div>
      </section>
