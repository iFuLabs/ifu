    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-muted">You're on the FinOps plan</p>
          </div>
          <span className="text-xs px-3 py-1 bg-brand-light text-brand rounded-full font-mono">Trial</span>
        </div>
        ...
        <button className="w-full px-4 py-2 bg-brand text-white text-sm rounded-lg hover:bg-brand-mid transition-all">
          Upgrade plan
        </button>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        ...
        <div className="flex items-center gap-3 p-4 bg-surface border border-border rounded-lg">
          ...
          <button className="text-xs text-brand hover:underline">Add card</button>
        </div>
      </div>
