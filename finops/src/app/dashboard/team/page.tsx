        ...
        <div className="divide-y divide-border">
          {members?.map((member: any) => (
            <div key={member.id} className="flex items-center gap-4 px-5 py-4">
              <div className="w-10 h-10 rounded-full bg-brand flex items-center justify-center text-white font-medium flex-shrink-0">
            ...
            {!inviteUrl ? (
              <>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-bg border border-border rounded-lg text-sm text-ink focus:outline-none focus:border-brand"
                    >
                      <option value="member">Member — Can view cost analysis</option>
                ...
                <div className="flex gap-2 mt-6">
                  ...
                  <button
                    ...
                    disabled={inviting}
                    className="flex-1 px-4 py-2 bg-brand text-white rounded-lg text-sm hover:bg-brand-mid transition-colors disabled:opacity-50"
                  >
              ...
              <>
                <div className="text-center py-4">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-bg border border-border rounded-lg mb-4">
                    ...
                    <button
                      ...
                      className="flex-shrink-0 p-1 text-brand hover:text-brand-mid transition-colors"
                    >
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-brand text-white rounded-lg text-sm hover:bg-brand-mid transition-colors"
                >
                  Done
                </button>
              </>
