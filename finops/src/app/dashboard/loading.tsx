  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-bg">
      <div className="text-center">
        <div className="w-16 h-16 bg-brand rounded-xl flex items-center justify-center mx-auto mb-4 animate-pulse">
        ...
        <p className="font-mono text-sm text-muted">Loading iFu Costless...</p>
      </div>
    </div>
  )
}
